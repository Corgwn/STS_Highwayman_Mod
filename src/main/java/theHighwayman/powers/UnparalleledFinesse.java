...
public class UnparalleledFinesse extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("UnparalleledFinesse84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("UnparalleledFinesse32.png"));
