...
public class FutureBleed extends AbstractPower implements CloneablePowerInterface {
    private boolean consume;
    public AbstractCreature source;

    public static final String POWER_ID = makeID("FutureBleed");
    ...
    public FutureBleed(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
    ...
    public void atStartOfTurn() {
        if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT && !AbstractDungeon.getMonsters().areMonstersBasicallyDead()) {
            this.addToBot(new ApplyPowerAction(this.owner, this.source, new Bleed(this.owner, this.source, this.amount)));
            this.addToBot(new RemoveSpecificPowerAction(this.owner, this.source, makeID("FutureBleed")));
        }
    }

    @Override
    public AbstractPower makeCopy() {
        return new FutureBleed(owner, source, amount);
    }
}
