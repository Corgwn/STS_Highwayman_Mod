...
import theHighwayman.actions.WickedSliceAction;
...
public class WickedSlice extends AbstractDynamicCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new WickedSliceAction(m, new DamageInfo(p, damage, damageTypeForTurn)));
    }
