...
public class Reflexes extends AbstractPower implements CloneablePowerInterface, OnReceivePowerPower {

    public AbstractCreature source;

    public static final String POWER_ID = makeID("Reflexes");
    ...
    public Reflexes(final AbstractCreature owner, final int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new Reflexes(owner, amount);
    }
