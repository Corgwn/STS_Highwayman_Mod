...
public class PistolShot extends AbstractShotCard {
    ...
    public static final String IMG = makeCardPath("PistolShot.png");
    ...
    public PistolShot() {
        ...
        this.tags.add(CustomTags.SHOT); //Tag your strike, defend and form (Wraith form, Demon form, Echo form, etc.) cards so that they function correctly.
    }
