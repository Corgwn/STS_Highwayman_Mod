...
public class UnparalleledFinesse extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("unparalleled_finesse84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("unparalleled_finesse32.png"));
