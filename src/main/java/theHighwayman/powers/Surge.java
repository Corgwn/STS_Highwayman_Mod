...
public class Surge extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("DuelistsSurge84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("DuelistsSurge32.png"));
