...
public class Dodge extends AbstractPower implements CloneablePowerInterface {
    ...
    public Dodge(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new Dodge(owner, source, amount);
    }
}
