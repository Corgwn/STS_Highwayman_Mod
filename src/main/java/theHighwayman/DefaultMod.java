...
import theHighwayman.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String AUTHOR = "Corgwn"; // And pretty soon - You!
    ...
    // Colors (RGB)
    // Character Color
    public static final Color DEFAULT_GRAY = CardHelper.getColor(20.0f, 00.0f, 137.0f);
    ...
    public static final String BADGE_IMAGE = "theHighwaymanResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theHighwaymanResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theHighwaymanResources/images/char/defaultCharacter/skeleton.json";
    ...
    public DefaultMod() {
      ...
      */
        ...
        logger.info("Creating the color " + theHighwayman.Enums.COLOR_GRAY.toString());
        
        BaseMod.addColor(theHighwayman.Enums.COLOR_GRAY, DEFAULT_GRAY, DEFAULT_GRAY, DEFAULT_GRAY,
    ...
    public void receiveEditCharacters() {
        logger.info("Beginning to edit characters. " + "Add " + theHighwayman.Enums.THE_DEFAULT.toString());
        
        BaseMod.addCharacter(new theHighwayman("the Default", theHighwayman.Enums.THE_DEFAULT),
                THE_DEFAULT_BUTTON, THE_DEFAULT_PORTRAIT, theHighwayman.Enums.THE_DEFAULT);
        
        receiveEditPotions();
        logger.info("Added " + theHighwayman.Enums.THE_DEFAULT.toString());
    }
