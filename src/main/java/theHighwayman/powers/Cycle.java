...
public class Cycle extends AbstractPower implements CloneablePowerInterface {

    public AbstractCreature source;

    public static final String POWER_ID = makeID("Cycle");
    ...
    public Cycle(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new Cycle(owner, source, amount);
    }
}
