...
public class TwistedTip extends AbstractPower implements CloneablePowerInterface {

    public AbstractCreature source;

    public static final String POWER_ID = makeID("TwistedTip");
    ...
    public TwistedTip(final AbstractCreature owner, final AbstractCreature source) {
        this.name = NAME;
        this.ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new TwistedTip(owner, source);
    }
}
